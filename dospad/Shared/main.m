...
int main(int argc, char *argv[]) {
    @autoreleasepool {
        ...
        NSString *cPath=[[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"diskc"];
        NSString *dPath=[fso documentsDirectory];

        strcpy(diskc, [cPath UTF8String]);
        strcpy(diskd, [dPath UTF8String]);
#else
